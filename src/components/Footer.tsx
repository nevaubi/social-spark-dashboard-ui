...
export default function Footer() {
  ...
  return (
    <footer className="py-10 border-t border-border/50 blue-peach-gradient relative">
      ...
      <div className="container px-4 sm:px-8">
        <div className="flex flex-col items-center justify-center">
          <div className="mb-4 flex items-center gap-2">
            <div className="rounded-xl bg-primary w-8 h-8 flex items-center justify-center soft-glow">
