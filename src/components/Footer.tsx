...
export default function Footer() {
  ...
  return (
    <footer className="py-10 border-t border-border/50 bg-white dark:bg-gray-900 relative">
      ...
      <div className="container px-4 sm:px-8">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 text-[15px] text-muted-foreground">
